...
public class SampleHazelcastApp {

    private static final Logger log = LoggerFactory.getLogger(SampleHazelcastApp.class);

    @Inject
    private Environment env;

    /**
     * Initializes sampleHazelcast.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(SampleHazelcastApp.class);
