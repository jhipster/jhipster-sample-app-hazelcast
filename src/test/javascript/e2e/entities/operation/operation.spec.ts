...
describe('Operation e2e test', () => {
    ...
    it('should load Operations', async () => {
        ...
        expect(await operationComponentsPage.getTitle()).toMatch(/jhipsterHazelcastSampleApplicationApp.operation.home.title/);
    });
    ...
    it('should load create Operation page', async () => {
        ...
        expect(await operationUpdatePage.getPageTitle()).toMatch(/jhipsterHazelcastSampleApplicationApp.operation.home.createOrEditLabel/);
    ...
    it('should delete last Operation', async () => {
        ...
        expect(await operationDeleteDialog.getDialogTitle()).toMatch(/jhipsterHazelcastSampleApplicationApp.operation.delete.question/);
